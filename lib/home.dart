...
import 'package:flutter_webviewx/helpers.dart';
...
class _WebViewXPageState extends State<WebViewXPage> with TickerProviderStateMixin {
  late WebViewXController webviewController;
  // final initialContent =
  //     '<h4> This is some hardcoded HTML code embedded inside the webview <h4> <h2> Hello world! <h2>';
   String _currentURL='';
   String _targetURL='https://news.ycombinator.com/';
  ValueNotifier _valueNotifier = ValueNotifier(false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
         _currentURL==_targetURL ? Padding(
  ...
  void initState() {
    ...
    _valueNotifier.addListener(() {
      debugPrint('debugPrint: ${webviewController.getContent()}');
  ...
  Widget _buildWebViewX() {
    return WebViewX(
      ...
      height: screenSize.height-56-25,
...
,
      ...
      // jsContent: const {
      //   EmbeddedJsContent(
      //     js: '''function testPlatformIndependentMethod() { window.location.replace("http://www.w3schools.com") }''',
      //   ),
      //   EmbeddedJsContent(
      //     webJs:
